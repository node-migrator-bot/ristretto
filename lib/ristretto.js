(function() {
      ...
      module.body = this.load(fileName).replace(/require\(('|")(.*?)\1\)/g, __bind(function(_, _, req, pos, contents) {
        ...
        depName = (function() {
          try {
            ...
            throw new Ristretto.Error(req, fileName);
          }
        }).call(this);
  ...
  Ristretto.Error = (function() {
    __extends(Error, Error);
    function Error(req, fileName) {
      this.req = req;
      this.fileName = fileName;
      this.message = "Unknown module `" + this.req + "` required in file `" + this.fileName + "`";
    }
    return Error;
  })();
